    ...
    def model_fit_predict(self):
        ...
        for col, num in self.__categorical_columns_num_unique.items():
            ...
            embedding_layer = Embedding(
                input_dim=num, output_dim=min(50, num // 2), input_length=1, name=col+"_embedding")(input_layer)
        ...
        plot_model(
            self.__net, to_file=os.path.join(self.__output_path, "model_plot.png"), show_shapes=True, show_layer_names=True)
